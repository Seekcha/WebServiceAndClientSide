       ...
       <nav class="navbar navbar-default">
          <ul class="nav navbar-nav">
            <li><a href="Default.aspx">View Patient</a></li>
              <li><a href="AddInterface.aspx">Adding Patient</a></li>
          </ul>
        </nav>
       <h1>Update Patient</h1>
          <div class="container">
            ...
            <div class="center-page">
                <div style="color:orangered;">Insert Patient ID</div>
                <asp:TextBox ID="txtSearch" class="form-control" runat="server"></asp:TextBox>
                <asp:Button ID="btnClick" CssClass="btn btn-primary" runat="server" Text="Search" OnClick="Button1_Click" /><br /><br /></div>
            <div class="form-group">
                
                <asp:Label ID="lfilecode" runat="server" Text="Filecode: "></asp:Label>
                <asp:TextBox ID="filecodetxt" class="form-control" runat="server" ReadOnly="true"></asp:TextBox>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="gendertxt" class="form-control" runat="server" ReadOnly="true"></asp:TextBox>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="bgtxt" class="form-control" runat="server" ReadOnly="true"></asp:TextBox>
            </div>
            <div class="form-group">
            ...
            <asp:Button ID="btnEdit" runat="server" class="btn btn-success " Text="Edit" OnClick="btnEdit_Click" />&nbsp;&nbsp;&nbsp;
            <asp:LinkButton class="btn btn-danger " ID="lbtnCancel" runat="server" href="Default.aspx">Cancel</asp:LinkButton>
        </div>
   </form>        
